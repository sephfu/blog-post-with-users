...
def get_all_posts():
    ...
    return render_template("index.html", all_posts=posts, is_login=current_user.is_authenticated, current_user=current_user)
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("post.html", post=requested_post, is_login=current_user.is_authenticated, current_user=current_user, form=form, comments=requested_post.comments)
